...
console.log('Створити 3 об\'єкти які описують книги. Поля об\'єкту : title ,pageCount, genre.')
...
console.log('Створити 3 об\'єкти які описують книги. Поля об\'єкту : title ,pageCount, genre, authors.')
let book4 = {
